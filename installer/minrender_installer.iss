...
DefaultDirName={autopf}\MinRender
...
Name: "plugins\blender"; Description: "Blender addon (MinRender.py)"; Types: full
Name: "plugins\cinema4d"; Description: "Cinema 4D script (MinRender.py)"; Types: full
Name: "plugins\aftereffects"; Description: "After Effects script (MinRender.jsx)"; Types: full
...
[Tasks]
Name: "cleanconfig"; Description: "Remove user configuration (%LOCALAPPDATA%\MinRender\config.json) - NOT RECOMMENDED"; GroupDescription: "User data cleanup:"; Flags: unchecked
Name: "cleanall"; Description: "Remove ALL user data (%LOCALAPPDATA%\MinRender\) - NOT RECOMMENDED"; GroupDescription: "User data cleanup:"; Flags: unchecked
...
Root: HKLM; Subkey: "Software\Classes\Applications\{#MyAppExeName}"; ValueType: string; ValueName: "AppUserModelID"; ValueData: "cbkow.minrender"; Flags: uninsdeletekey
...
begin
  ...
  begin
    ...
    LocalAppData := ExpandConstant('{localappdata}\MinRender');
  ...
  begin
    ...
    Exec('netsh', 'advfirewall firewall delete rule name="MinRender UDP"',
         '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
    Exec('netsh', 'advfirewall firewall add rule name="MinRender" dir=in action=allow protocol=tcp localport=8420 enable=yes',
         '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
    Exec('netsh', 'advfirewall firewall add rule name="MinRender UDP" dir=in action=allow protocol=udp localport=4243 enable=yes',
         '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
...
begin
  ...
  begin
    ...
    UserDataDir := ExpandConstant('{localappdata}\MinRender');
    if DirExists(UserDataDir) then
    begin
      Response := MsgBox('Do you want to delete your MinRender user data and configuration?' + #13#10 +
...
[Messages]
; Custom messages
WelcomeLabel2=This will install [name/ver] on your computer.%n%nMinRender is a render farm coordinator for freelancers and small teams.%n%nIt is recommended that you close all other applications before continuing.
